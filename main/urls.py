...
urlpatterns = [
    ...
    re_path(r'^(?P<ui_lang>ko|en)/minigame/?$', views.minigame_page, name='minigame_lang'),
    re_path(r'^(?P<ui_lang>ko|en)/bubble/?$', views.bubble_page, name='bubble_lang'),
    ...
    path('minigame', views.minigame_legacy_redirect, name='minigame_no_slash'),
    path('minigame/', views.minigame_legacy_redirect, name='minigame'),
    path('bubble', views.bubble_legacy_redirect, name='bubble_no_slash'),
    path('bubble/', views.bubble_legacy_redirect, name='bubble'),
