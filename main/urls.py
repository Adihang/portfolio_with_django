...
urlpatterns = [
    ...
    path('docs', docs_views.docs_root_legacy_redirect, name='docs_root'),
    path('docs/', docs_views.docs_root_legacy_redirect),
    path('docs/list', docs_views.docs_list_root_legacy_redirect, name='docs_list_root'),
    path('docs/list/', docs_views.docs_list_root_legacy_redirect),
    path('docs/write', docs_views.docs_write_legacy_redirect, name='docs_write'),
    path('docs/write/', docs_views.docs_write_legacy_redirect),
    path('docs/login', docs_views.docs_login_legacy_redirect, name='docs_login'),
    path('docs/login/', docs_views.docs_login_legacy_redirect),
    path('docs/logout', docs_views.docs_logout_legacy_redirect, name='docs_logout'),
    ...
    path('docs/api/preview', docs_views.docs_api_preview, name='docs_api_preview'),
    ...
    path('docs/api/move', docs_views.docs_api_move, name='docs_api_move'),
    ...
    re_path(r'^(?P<ui_lang>ko|en)/docs/login/?$', docs_views.docs_login, name='docs_login_lang'),
    re_path(r'^(?P<ui_lang>ko|en)/docs/logout/?$', docs_views.docs_logout, name='docs_logout_lang'),
